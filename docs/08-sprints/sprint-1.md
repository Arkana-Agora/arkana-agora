...
- [x] 1c. Credentials e-mail/senha — Sprint 1 (ADR-010 §10) — **parcial: `POST /api/v1/auth/register` (T6), `POST /api/v1/auth/login` (T7), LoginForm frontend (T19), RegisterForm frontend (T20) e MagicLinkForm frontend (T21) implementados**
