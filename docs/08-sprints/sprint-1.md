...
- [x] 1c. Credentials e-mail/senha — Sprint 1 (ADR-010 §10) — **parcial: `POST /api/v1/auth/register` (T6), `POST /api/v1/auth/login` (T7) e LoginForm frontend (T19) implementados**
